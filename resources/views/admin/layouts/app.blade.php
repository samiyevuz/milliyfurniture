    ...
    <aside class="hidden md:flex w-64 bg-white shadow-lg flex-col border-r border-gray-200">
        ...
        <nav class="flex-1 px-4 py-6 space-y-1">
            <a href="{{ route('admin.dashboard') }}" 
               class="flex items-center px-4 py-3 rounded-lg transition {{ request()->routeIs('admin.dashboard') || request()->is('admin') ? 'bg-[#0A4C8A] text-white' : 'text-gray-700 hover:bg-gray-100' }}">
